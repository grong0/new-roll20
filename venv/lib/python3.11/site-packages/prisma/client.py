...
SCHEMA_PATH = Path('/home/garrettt/Coding Programs/new-roll20/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'debian-openssl-1.1.x': '/home/garrettt/.cache/prisma-python/binaries/5.4.2/ac9d7041ed77bcc8a8dbd2ab6616b39013829574/node_modules/prisma/query-engine-debian-openssl-1.1.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    ...
    lineage: 'actions.LineageActions[models.Lineage]'
    race: 'actions.RaceActions[models.Race]'
    description: 'actions.DescriptionActions[models.Description]'
    feat: 'actions.FeatActions[models.Feat]'
    table: 'actions.TableActions[models.Table]'
    row: 'actions.RowActions[models.Row]'
    ...
    def __init__(
        ...
        *,
        ...
        self.lineage = actions.LineageActions[models.Lineage](self, models.Lineage)
        self.race = actions.RaceActions[models.Race](self, models.Race)
        self.description = actions.DescriptionActions[models.Description](self, models.Description)
        self.feat = actions.FeatActions[models.Feat](self, models.Feat)
        self.table = actions.TableActions[models.Table](self, models.Table)
        self.row = actions.RowActions[models.Row](self, models.Row)
...
class Batch:
    ...
    lineage: 'LineageBatchActions'
    race: 'RaceBatchActions'
    description: 'DescriptionBatchActions'
    feat: 'FeatBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.lineage = LineageBatchActions(self)
        self.race = RaceBatchActions(self)
        self.description = DescriptionBatchActions(self)
        self.feat = FeatBatchActions(self)
        self.table = TableBatchActions(self)
        self.row = RowBatchActions(self)
