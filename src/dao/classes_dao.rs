...
use super::common::{
    form_key, serde_as_array, serde_as_array_mapping, serde_as_bool, serde_as_object, serde_as_object_from_option, serde_as_string, serde_as_u64, AdditionalSpells, ArmorProficiencies, ClassStartingEquipment, ClassTableGroup, ClassWeaponProficiencies, Entry, HitDie, Multiclassing,
    MulticlassingRequirements, OptionalClassFeatureProgression, Proficiencies, SkillProficiencies, Source, StartingEquipment, ToolProficiencies,
};
...
pub struct Class {
    ...
    pub optional_feature_progressions: OptionalClassFeatureProgression,
    ...
    pub class_features: Vec<OptionalClassFeatureProgression>,
...
impl Class {
	pub fn new(value: Value) -> Class {
        ...
        return Class {
            ...
            optional_feature_progressions: OptionalClassFeatureProgression::new(object.get("optionalFeatureProgression")),
            ...
            class_features: serde_as_array(object.get("optionalFeatureProgression")).iter().map(|i| OptionalClassFeatureProgression::new(Some(i))).collect(),
